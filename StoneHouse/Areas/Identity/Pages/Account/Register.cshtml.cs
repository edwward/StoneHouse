...
namespace StoneHouse.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        //get handler - v razorpages se actionmetody nazyvaji handler
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //vytvor noveho applicationusera
                ...
                if (result.Succeeded)
                {
                    if (!await _roleManager.RoleExistsAsync(SD.AdminEndUser))  //vytvor nove role, pokud jeste neexistuji
                    {
                    ...
                    if (Input.IsSuperAdmin) //pokud je checkbox k superadminovy zaskrtly
                    {
